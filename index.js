    ...
    let num = req.query.number;
     ...
     try {
            ...
            let session_id  = await sparky.sendMessage(sparky.user.id, { 
               text: 'QUEEN-BOT-MD:'+c.trim()
            })
            //session quarted sender 
            let cc = `*⚠️ Don't Share The SESSION-ID ☝🏻 Shown Above*.\n\n*Web :* *https://queen-md-qr-elctro-wizard.koyeb.app*\n\n\n*BY GIDDY TENNOR 🗿*`;
...
*REPO*
https://github.com/TENNORMODZCODER /QUEEN-BOT
            
            
*ᴊᴏɪɴ sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ ғᴏʀ ᴍᴏʀᴇ ϙᴜᴇʀʏ*
https://chat.whatsapp.com/DCw0WuzzJq66HLHhcjoAdD
...
*© GIDDY TENNOR*` }, {quoted: session_id});
